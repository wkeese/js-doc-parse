define([ '../Module', '../Value', './util', '../console', 'dojo/node!fs' ], function (Module, Value, util, console, fs) {
	/**
	 ...
	 */
	function generateTree(jsonFile){
	...
	return function (config) {
		if (!config.tree) {
			throw new Error('A config.tree value must be provided for the tree exporter.');
		}
